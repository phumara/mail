# Generated by Django 5.2.7 on 2025-10-23 07:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('campaigns', '0009_template_alter_campaign_template'),
        ('subscribers', '0004_auto_20251023_1131'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='campaign',
            name='from_name',
            field=models.CharField(default='Mail System', max_length=255, verbose_name='From Name'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='html_content',
            field=models.TextField(default='<p>Default campaign content</p>', verbose_name='HTML Content'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='reply_to_email',
            field=models.EmailField(blank=True, max_length=254, verbose_name='Reply To'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='sent_at',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='subscribers.segment', verbose_name='Subscriber Segments'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='text_content',
        ...
        migrations.AddField(
            model_name='campaign',
            name='total_bounced',
            field=models.IntegerField(default=0, verbose_name='Total Bounced'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='total_clicked',
            field=models.IntegerField(default=0, verbose_name='Total Clicked'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='total_delivered',
            field=models.IntegerField(default=0, verbose_name='Total Delivered'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='total_opened',
            field=models.IntegerField(default=0, verbose_name='Total Opened'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='total_recipients',
            field=models.IntegerField(default=0, verbose_name='Total Recipients'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='total_sent',
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(default=0, verbose_name='Total Unsubscribed'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='updated_at',
        ...
        migrations.AlterField(
            model_name='campaign',
            name='from_email',
            field=models.EmailField(default='noreply@example.com', max_length=254, verbose_name='From Email'),
        ),
        migrations.AlterField(
            model_name='campaign',
            name='name',
            field=models.CharField(max_length=255, verbose_name='Campaign Name'),
        ),
        migrations.AlterField(
            model_name='campaign',
            name='scheduled_at',
        ...
        migrations.AlterField(
            model_name='campaign',
            name='status',
            field=models.CharField(choices=[('draft', 'Draft'), ('scheduled', 'Scheduled'), ('sending', 'Sending'), ('sent', 'Sent'), ('paused', 'Paused'), ('cancelled', 'Cancelled')], default='draft', max_length=20, verbose_name='Status'),
        ),
        migrations.AlterField(
            model_name='campaign',
            name='subject',
            field=models.CharField(max_length=500, verbose_name='Email Subject'),
        ),
        migrations.CreateModel(
            name='EmailTemplate',
            fields=[
        ...
        migrations.AddField(
            model_name='campaign',
            name='smtp_provider',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='campaigns.smtpprovider'),
        ),
        ...
        migrations.AddIndex(
            model_name='emaillog',
            index=models.Index(fields=['subscriber_email', 'status'], name='campaigns_e_subscri_e0a7b8_idx'),
        ),
        migrations.AddIndex(
            model_name='emaillog',
            index=models.Index(fields=['smtp_provider', 'sent_at'], name='campaigns_e_smtp_pr_5bf9da_idx'),
        ),
    ]
